...
#import "LotteryRunloop.h"
#import <objc/message.h>

@interface LotteryRunloop ()
...
@implementation LotteryRunloop

CLASSSINGLE_M(Instance)
...
static void Callback(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info){
    ...
    //通过info桥接为当前的对象
    LotteryRunloop * runloop = (__bridge LotteryRunloop *)info;
...
//动态添加属性
@implementation UITableViewCell (LotteryRunloop)
